            ...
            <HoverCardContent>
              <div className="p-2">
                ...
                <div className="grid grid-cols-3 gap-1">
                  {Object.keys(statesData[0].region).length > 0 && ['North', 'South', 'East', 'West', 'Central', 'Northeast'].map(region => (
                    <div key={region} className="flex items-center">
                      <div 
                        className="w-3 h-3 mr-1 rounded-full" 
                        style={{ backgroundColor: getStateColor(statesData.find(s => s.region === region)?.id || '') }}
                      ></div>
      ...
      <div className="flex flex-col md:flex-row h-[calc(100%-2rem)]">
        <div className="w-full md:w-2/3 flex items-center justify-center relative">
          ...
          >
            ...
            <path id="JK" d="M200,90 L230,60 L270,40 L310,60 L320,90 L300,120 L270,140 L240,120 L210,110 Z" 
            ...
            />
            <path id="HP" d="M270,140 L300,120 L330,130 L340,150 L320,170 L290,180 L270,160 Z" 
                  ...
                  className="hover:opacity-80"
            />
            <path id="PB" d="M270,160 L290,180 L290,210 L270,220 L250,200 L260,180 Z" 
                  ...
                  className="hover:opacity-80"
            />
            <path id="UK" d="M320,170 L340,150 L370,160 L380,180 L370,200 L340,190 Z" 
                  ...
                  className="hover:opacity-80"
            />
            <path id="HR" d="M290,180 L320,170 L340,190 L330,220 L300,230 L290,210 Z" 
            ...
            <path id="UP" d="M300,230 L330,220 L370,200 L400,210 L420,240 L410,270 L380,290 L350,270 L320,250 Z" 
                  ...
                  className="hover:opacity-80"
            />
            <path id="RJ" d="M220,220 L250,200 L270,220 L300,230 L320,250 L310,280 L260,310 L220,290 L200,260 L210,240 Z" 
                  ...
                  className="hover:opacity-80"
            />
            <path id="MP" d="M260,310 L310,280 L350,270 L380,290 L390,320 L380,350 L340,370 L290,350 L260,330 Z" 
            ...
            <path id="BR" d="M380,290 L410,270 L440,270 L460,290 L450,310 L420,320 L390,320 Z" 
                  ...
                  className="hover:opacity-80"
            />
            <path id="WB" d="M460,290 L480,270 L490,290 L480,320 L490,350 L470,370 L450,350 L450,310 Z" 
                  ...
                  className="hover:opacity-80"
            />
            <path id="JH" d="M420,320 L450,310 L450,350 L420,350 L400,340 Z" 
                  ...
                  className="hover:opacity-80"
            />
            <path id="OD" d="M400,340 L420,350 L450,350 L470,370 L460,390 L420,400 L390,380 L380,350 Z" 
            ...
            <path id="GJ" d="M170,290 L200,260 L220,290 L240,310 L220,340 L190,350 L160,320 L140,300 Z" 
                  ...
                  className="hover:opacity-80"
            />
            <path id="MH" d="M240,310 L260,310 L260,330 L290,350 L340,370 L330,400 L280,420 L250,410 L210,380 L220,340 Z" 
            ...
            <path id="CG" d="M340,370 L380,350 L390,380 L370,410 L330,400 Z" 
                  ...
                  className="hover:opacity-80"
            />
            <path id="TS" d="M330,400 L370,410 L360,440 L320,430 Z" 
                  ...
                  className="hover:opacity-80"
            />
            <path id="AP" d="M320,430 L360,440 L370,410 L390,420 L380,460 L360,490 L330,470 L310,440 Z" 
                  ...
                  className="hover:opacity-80"
            />
            <path id="KA" d="M280,420 L330,400 L320,430 L310,440 L290,470 L260,450 L250,420 Z" 
                  ...
                  className="hover:opacity-80"
            />
            <path id="TN" d="M290,470 L310,440 L330,470 L360,490 L350,520 L320,540 L290,520 L280,490 Z" 
                  ...
                  className="hover:opacity-80"
            />
            <path id="KL" d="M260,450 L290,470 L280,490 L290,520 L270,530 L250,510 L240,480 Z" 
            ...
            <path id="AS" d="M490,240 L530,220 L560,230 L570,260 L540,270 L500,260 Z" 
                  ...
                  className="hover:opacity-80"
            />
            <path id="ML" d="M520,270 L540,270 L530,290 L510,290 Z" 
                  ...
                  className="hover:opacity-80"
            />
            <path id="MZ" d="M540,270 L570,260 L570,290 L550,300 L530,290 Z" 
                  ...
                  className="hover:opacity-80"
            />
            <path id="TR" d="M530,290 L550,300 L520,310 L510,290 Z" 
                  ...
                  className="hover:opacity-80"
            />
            <path id="MN" d="M570,260 L590,250 L600,270 L590,300 L570,290 Z" 
                  ...
                  className="hover:opacity-80"
            />
            <path id="NL" d="M560,230 L580,220 L590,250 L570,260 Z" 
                  ...
                  className="hover:opacity-80"
            />
            <path id="AR" d="M530,200 L560,190 L580,200 L580,220 L560,230 L530,220 Z" 
                  ...
                  className="hover:opacity-80"
            />
            <path id="SK" d="M490,220 L510,210 L520,230 L490,240 Z" 
                  ...
                  className="hover:opacity-80"
            />
            <path id="GA" d="M230,390 L240,380 L260,390 L250,410 Z" 
            ...
            <path 
              d="M170,290 L200,260 L220,220 L210,240 L200,260 L170,290 Z
                 ...
                 M250,410 L280,420 L250,420 L260,450 L240,480 L250,510 L270,530 L290,520 L320,540 L350,520 L360,490 L380,460 L390,420 L420,400 L460,390 L470,370 L490,350 L480,320 L490,290 L480,270 L490,240 L500,260 L490,290 L480,270 L490,240 Z"
              fill="none"
              stroke="#555"
              strokeWidth="1"
          ...
          {hoveredState && (
            <div className="absolute pointer-events-none bg-white p-2 rounded-md shadow-md text-xs border border-gray-200 max-w-[200px] z-10"
                style={{ 
                  top: '50%', 
                  left: '50%', 
