...
const Chatbot = () => {
  const [messages, setMessages] = useState([
    {
      role: 'bot',
      content: 'Namaste! I am Kisan Mitra, your agricultural assistant. How can I help you with Indian agriculture today?',
      timestamp: new Date()
    }
  ]);
  ...
  const handleSendMessage = async () => {
    ...
    try {
      const response = await fetch("https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=AIzaSyBp8m7FY-8chr9jFt8s0tpp8LoFL_795B0", {
        method: 'POST',
        headers: {
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-6 flex flex-col">
        <div className="mb-6 flex items-center">
          ...
          <div>
            <h1 className="text-2xl font-bold">Kisan Mitra Chatbot</h1>
            <p className="text-gray-600">Your agricultural assistant for Indian farming queries</p>
          </div>
        </div>
        ...
        <div className="flex-1 bg-white rounded-lg shadow-md border border-gray-200 flex flex-col">
          <div className="p-4 bg-kisan-green bg-opacity-10 rounded-t-lg border-b border-gray-200">
            <div className="flex items-center">
              ...
              <h2 className="font-medium text-kisan-green">Kisan Mitra</h2>
          ...
          <div className="p-4 border-t border-gray-200">
            <div className="flex items-end space-x-2">
              <Textarea
                placeholder="Ask about Indian agriculture..."
                value={inputMessage}
            ...
            <p className="text-xs text-gray-500 mt-2 text-center">
              This chatbot answers questions about Indian agriculture only
            </p>
          </div>
        </div>
      </main>
